...
var css = `.grid { position: fixed; top: 0; left: 50%; height: 100%; width: 100%; max-width: 75rem; transform: translateX(-50%); pointer-events: none; display: grid; grid-template-columns: repeat(${maxGridCol}, 1fr); grid-gap: 30px; z-index: 99999; border: 1px solid orange; padding: ${paddingGrid}; } .grid--fullWidth { max-width: initial; border: none;} .grid__col { opacity: 0.15; background-color: #000000;} .gridInfos { position: fixed; top: 50%; right: 0; transform: translateY(-50%); color: white; background-color: rgba(0, 0, 0, 0.5); padding: 15px; z-index: 99999; } .gridInfos__item { display: flex;
    line-height: 1.5; } .gridInfos__property__columns, .gridInfos__property__gutters, .gridInfos__property__fullWidth { width: 90px; } .cross { position: fixed; top: 0; left: 0; height: 100%; width: 100%; pointer-events: none; z-index: 99999; } .cross__verticalLine { position: absolute; left: 50%; height: 100%; width: 1px; background: orange; } .cross__horizontalLine { position: absolute; top: 50%; height: 1px; width: 100%; background: orange; }`;
